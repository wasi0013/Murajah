...
const en: Messages = {
  ...
  settings: {
    ...
    dangerZone: {
      ...
      reset: {
        ...
        confirmBody:
          "This permanently erases all your data and cached files on this device. There is no undo, so make sure you've exported a backup above if you want to keep anything.",
  ...
  plan: {
    ...
    restDays: 'Rest days',
    restHint: 'New memorization pauses; revision carries on, since hifz fades on days off too.',
    restOn: 'Rest on {day}',
  ...
  download: {
    brand: 'Murajah',
    tagline: 'Your daily companion for Quran memorization & revision.',
    installAndroid: 'Install for Android',
    installIos: 'Install for iOS',
    demosEyebrow: 'See it in action',
    demosTitle: 'Everything you need to memorize.',
    demosLead: 'A closer look at the tools that make daily memorization stick.',
    demo: {
      wbw: {
      ...
      audio: {
        title: 'Listen & record',
        body: '14 verse-by-verse reciters, continuous playback by surah, juz, or the whole Quran, and recording your own recitation to review.',
    ...
    processTitle: 'A clear path to lifelong retention.',
    processLead: 'No overwhelming page-at-a-time grind: just small, repeatable steps that fit into a busy day.',
    step: {
      read: {
        title: 'Start reading',
    ...
    ctaTitle: 'Ready to start your memorization journey?',
    ctaSub: 'Free and open-source. Step by step, verse by verse.',
    googlePlayAlt: 'Get it on Google Play',
    installIosAlt: 'Install on iOS',
    joinDiscord: 'Join the Discord',
    ios: {
      eyebrow: 'Install on iOS as app',
      title: 'Add Murajah to your Home Screen',
      lead: "iOS doesn't have a Murajah app in the App Store. Instead, you can add the web app to your Home Screen so it opens and feels just like a regular app. Watch the short video below, or follow the written steps.",
      videoTitle: 'How to install Murajah on iOS',
      option1Title: 'Option 1: Quick Safari method',
      option1Note: '(uses the default web icon)',
      option1Step1:
        'Open the <a href="https://murajah.pages.dev/" target="_blank" rel="noopener noreferrer">Murajah Web App</a> in <strong>Safari</strong>.',
      option1Step2: 'Tap the <strong>Share</strong> button (square with an arrow pointing up).',
      option1Step3: 'Scroll down and select <strong>Add to Home Screen</strong>.',
      option1Step4: 'Rename it if you want, then tap <strong>Add</strong>.',
      option2Title: 'Option 2: Shortcuts app',
      option2Note: '(allows a custom icon image)',
      option2Step1: 'Open the <strong>Shortcuts</strong> app and tap <strong>+</strong> in the top right.',
      option2Step2: 'Tap <strong>Add Action</strong>, search for <strong>Open URLs</strong>, and select it.',
      option2Step3: 'Paste the website link <code>https://murajah.pages.dev/</code> into the URL field.',
      option2Step4:
        'Tap the down arrow at the top (next to the shortcut name) → <strong>Add to Home Screen</strong>.',
      option2Step5: 'Tap the icon image to select a custom photo, set your title, and tap <strong>Add</strong>.',
    },
    discordTitle: 'Join the Murajah Discord',
    discordSub: 'Get support, share feedback, and connect with other reciters.',
  },
  preview: {
    ayah: 'Ayah {surah}:{ayah}',
