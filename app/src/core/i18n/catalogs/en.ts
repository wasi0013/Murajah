...
const en: Messages = {
  ...
  progress: {
    ...
    sheet: {
      ...
      currentNote: 'Last revised {date}.',
      decayedNote: 'Shows as {level} (last revised {date}) — revise to restore it.',
      noRevisionNote: 'No revision on record yet.',
      recordClean: 'Record a clean revision',
      hint: '“Record a clean revision” logs a perfect recitation from memory — it advances your review schedule and awards hasanah. The level above is just a label for where this page stands.',
