 ...
 */
export const formatScore = (num: number | null | undefined, decimals = 1): string => {
 ...
 */
export const formatScoreDetailed = (num: number | null | undefined, decimals = 1): string => {
  if (num === null || num === undefined || isNaN(num)) {
    return '0';
  }
 ...
 */
export const getScoreMagnitudeColor = (num: number): string => {
 ...
 */
export const getScoreMagnitudeBgColor = (num: number): string => {
 ...
 */
export const calculateScoreProgress = (current: number, target: number | null): number => {
 ...
 * Example: "Score: 1.5M"
 */
export const formatScoreWithLabel = (num: number, label = 'Score'): string => {
 ...
 */
export const parseFormattedScore = (formatted: string): number => {
