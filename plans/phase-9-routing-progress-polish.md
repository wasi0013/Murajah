...
- [ ] **9.5.3** Externalise the remaining hardcoded UI strings introduced in Phases 3–9 into the catalogs.
  ...
  - [ ] *Remaining surfaces:* reader chrome + More sheet (ReaderView), Listen, Live, Mushaf, Quiz, audio (tray/mini/reciter/recording), shared chrome (BottomTabBar, CommandPalette, dialogs), Gallery. Also habit catalog names/descriptions (data layer).
